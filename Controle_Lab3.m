...
% cruzamento wc
    Zat = novo_wc/10;
% 17. Calcule o polo do compensador de atraso: poloatraso = zeroatraso/
    Pat = Zat/alpha;
...
bode(G); hold; bode(Kkv * G, {1*10^-9, 1*10^9} ); bode(Kmp * Kkv * G); bode(C * Kmp * Kkv * G); grid on; legend('G','Kkv*G','Kmp*Kkv*G','Cat*Kmp*Kkv*G');
